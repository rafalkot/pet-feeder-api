Feature: Updating a task
  ...
  Scenario: Updating a task
    When I send a PUT request to "/api/tasks/9de30546-0b78-4671-b939-25522741d6bc" with body:
    """
      {
        "name": "Feed",
        "hour": "12:00:00",
  ...
  Scenario: Updating a task of other person
    When I send a PUT request to "/api/tasks/d1c74784-6c41-4558-be32-07b6ad466a39" with body:
    """
      {
        "name": "Feed",
        "hour": "12:00:00",
